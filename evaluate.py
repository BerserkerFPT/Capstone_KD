...
def strategy_2_top_k_average(model_name, checkpoint_manager, test_loader, train_loader, num_classes, device):
    """
...
def strategy_3_last_n_average(model_name, checkpoint_manager, test_loader, train_loader, num_classes, device):
    """
...
def evaluate_all_strategies(model_name, checkpoint_manager, test_loader, train_loader, num_classes, device):
    """
    ...
    strategy_2_results = strategy_2_top_k_average(
        model_name, checkpoint_manager, test_loader, train_loader, num_classes, device
    )
